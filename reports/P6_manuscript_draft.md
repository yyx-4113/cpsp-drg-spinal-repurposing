...
8. Reproducibility package (GitHub `yyx-4113/cpsp-drg-spinal-repurposing`, tag `v1.0.0` + `MANIFEST.sha256`): pack files are in place and released; Zenodo DOI is optional (not required for the Data Availability statement).
