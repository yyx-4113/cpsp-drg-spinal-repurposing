...
**Structure-based repurposing of approved drugs against DRG–spinal-cord-axis targets identifies α2A-adrenergic receptor (ADRA2A) as the leading chronic postsurgical pain target**
...
6. **In progress (this edit):** abstract, §3.3–§3.5 and §4 updated with the final, full-library numbers — including the composition-effect finding that ADRA2A's Tier-1 pass does not survive the pre-registered full-library test.
